  ...
  return (
    <div className="flex flex-col min-h-screen text-[#1a1a1a] overflow-x-hidden">
      ...
      <a
        ...
        className="fixed right-6 bottom-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-[#064e3b] text-white rounded-full flex items-center justify-center shadow-2xl hover:bg-[#053d2f] transition-all hover:scale-110 animate-bounce border-4 border-white"
      >
