  ...
  return (
    <div className="flex flex-col min-h-screen text-[#1a1a1a] overflow-x-hidden">
      ...
      <a
        ...
        className={`fixed right-6 z-50 w-14 h-14 md:w-16 md:h-16 bg-[#064e3b] rounded-full flex items-center justify-center shadow-lg hover:bg-[#053d2f] transition-all hover:scale-110 animate-bounce ${
          isCartActiveOnMobile ? 'bottom-28' : 'bottom-6'
        }`}
      >
